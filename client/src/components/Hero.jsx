        ...
        <div className="absolute inset-0 bg-black opacity-60"></div>
            <div className="mx-auto h-full w-[320px] sm:w-[480px]  md:w-[728px] 2xl:w-[1200px] relative z-10">
                <div className="h-full flex flex-col justify-center gap-2 text-white md:gap-8">
                    ...
                    <h1 className="text-2xl font-black md:w-1/2 sm:text-2xl lg:text-4xl 2xl:text-6xl">Nešto ste skecali i glupi ste da to popravite? Tu je za Vas <span className="text-orange-500">MeinMeister</span></h1>
                    <p className="md:text-lg md:w-1/2">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolor</p>
                    <button className="px-4 py-2 bg-transparent border border-white rounded-xl sm:self-start sm:px-8 sm:hover:scale-105 sm:hover:bg-white sm:hover:text-black sm:duration-300 lg:self-start mt-4 font-black">Pridružite nam se</button>
                </div>
            </div>
    </div>
  )
