...
const Category = ({imageUrl, title}) => {
  return (
    <div className="relative bg-auto bg-no-repeat bg-cover h-[400px] rounded-2xl cursor-pointer hover:scale-95 duration-300" style={{ backgroundImage: `url("${imageUrl}")` }}>
