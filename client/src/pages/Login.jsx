...
const Login = () => {
  return (
    <div className="flex flex-col justify-center relative h-screen py-[128px] bg-cover bg-no-repeat bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1614213951697-a45781262acf?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80')" }}>
      ...
      <div className="flex justify-center absolute top-50 left-0 right-0 mx-auto w-[320px] sm:w-[480px]  md:w-[728px] 2xl:w-[1200px]">
        <div className='flex flex-col gap-8 rounded-3xl w-[500px] bg-orange-500 p-16'>
          ...
          <form className='flex flex-col gap-4'>
            ...
            <p className='text-white self-center mt-5'>Nemate nalog? <Link className='font-semibold underline hover:text-gray-200 duration-200' to='/register'>Napravite nalog.</Link></p>
          </form>
        </div>
      </div>
    </div>
